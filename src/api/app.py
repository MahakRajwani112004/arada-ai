...
from src.api.routers import admin, agents, approvals, auth, conversations, csv_sql, knowledge, mcp, monitoring, oauth, secrets, skills, teams, workflow, workflows
...
app.include_router(csv_sql.router, prefix="/api/v1")
